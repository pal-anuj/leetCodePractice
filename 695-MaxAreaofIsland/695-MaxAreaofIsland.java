// Last updated: 02/09/2026, 07:12:29
1class Solution {
...
59    //     grid[r][c] = 0;
60    //     int area = 1;
61    //     area += maxAreaOfIsland(grid, r + 1, c);
62    //     area += maxAreaOfIsland(grid, r - 1, c);
63    //     area += maxAreaOfIsland(grid, r, c + 1);
64    //     area += maxAreaOfIsland(grid, r, c - 1);
65
66    //     return area;
67    // }
68}